...
const DeleteAProduct = (props) => {
        ...
        if (inputText.length > 0) {
            switch (filterOptions) {
                ...
                case "name":
                    setProducts_(
                        allProducts.filter(
                            (product) => product.name === inputText
                        )
                    );
                    setLoading(false);
                    return;
                case "price":
                    setProducts_(
                        allProducts.filter(
                            (product) => product.price.toString() === inputText
                        )
                    );
                    setLoading(false);
                    return;
    ...
    const handleDeleteProduct = async (e) => {
        ...
        setTimeout(msg, 1);
        setProducts_(
            allProducts.filter((user) => user._id !== currentProduct._id)
        );
        ...
        return allProducts !== null &&
            ...
            <Card plain>
                ...
                <CardBody>
                    ...
                    >
                        <span>{user.name}</span> <span>{product.user}</span>
                    </p>
                    <br />
                    ...
                    >
                        <span>Weight</span> <span>Branch</span>
                    </p>
                    <p
                        className={classes.pCardContent}
                        style={{
