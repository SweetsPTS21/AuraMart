        ...
        <Card profile style={{ textAlign: "left" }}>
            ...
            <CardBody profile>
                ...
                <Rating
                    ...
                    precision={0.5}
                />
                <p style={{ color: "#999999", fontSize: "0.9em" }}>
                    Created -{" "}
                    {Moment2(
                ...
                <p style={{ color: "#999999", fontSize: "0.9em" }}>
                    Reviewed product - {review.product.name}
                </p>
                <p style={{ color: "#999999", fontSize: "0.9em" }}>
                ...
                >
                    <Button
                        ...
                        onClick={() => {
                            ...
                            toggleReviewUpdateForm((val) => !val);
                        }}
                    >
                        Update Review
                    </Button>
    ...
    const handleSearch = (isSearchByRating, rating) => {
        if (isSearchByRating === true) {
            switch (rating) {
                case 1:
                    return setReviews_(
                        allReviews.filter((review) => review.rating === 1)
                    );
                case 2:
                    return setReviews_(
                        allReviews.filter((review) => review.rating === 2)
                    );
                case 3:
                    return setReviews_(
                        allReviews.filter((review) => review.rating === 3)
                    );
                case 4:
                    return setReviews_(
                ...
                case 5:
                    return setReviews_(
                        allReviews.filter((review) => review.rating === 5)
                    );
                default:
                    return reviews_;
            }
            ...
            switch (filterOptions) {
                case "id":
                    return setReviews_(
                        allReviews.filter((review) => review._id === inputText)
                    );
                case "productName":
                    return setReviews_(
                        allReviews.filter((review) => review._id === inputText)
                ...
                case "username":
                    return setReviews_(
                        allReviews.filter((review) => review.user === inputText)
                    );
                default:
                    return "";
            }
    ...
    return (
        <div style={{ width: "100%" }}>
            ...
            >
                <Grid item xs={2} md={2} lg={1} style={{ margin: 0 }}>
                    ...
                    >
                        ...
                        >
                            Find Review to Update or Delete
                        </Button>
                    </section>
                </Grid>
            ...
            >
                    ...
                    ? reviews_.map((review, index) => (
                          ...
                          >
                              <ReviewCard
                                  ...
                                  toggleReviewUpdateForm={setShowUpdateForm}
                              />
                          </Grid>
                      ))
                    : null}
                ...
                {reviews_ !== null &&
                    reviews_.length === 0 &&
                    !firstLoad && ( // if search result is empty
                        <Grid
                            item
                            xs={10}
                            md={10}
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    No reviews found with "{filterOptions2}"
                                    star rating.
                                </p>
                            </section>
                        </Grid>
