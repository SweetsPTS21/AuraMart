    ...
    return (
        <div style={{ width: "100%" }}>
            <Grid container spacing={3}>
                {productChart === null && props.noLoading === undefined && (
                    <ReactLoading
                        type={"balls"}
                        color={"#189EFF"}
                        width={"5%"}
                        ...
                        <Card chart onClick={convertDateToDay}>
                            <CardHeader color="success">
                                <ChartistGraph
                                    ...
                                    listener={productChart.animation}
                                />
                            </CardHeader>
                            <CardBody>
                                <h4 className={classes.cardTitle}>
                                    Amount of Products created in the last 7
                                    days{" "}
                                </h4>
                                <p className={classes.cardCategory}>
                                    <span className={classes.successText}>
                                        ...
                                        />{" "}
                                        {
                                            productChart.data.series[0].slice(
                                                -1
                                            )[0]
                                        }
                                    </span>{" "}
                                    increase in today's products.
                                </p>
                            </CardBody>
                            <CardFooter chart>
