    ...
    const handleSearch = () => {
        if (inputText.length > 0) {
            switch (filterOptions) {
                case "id":
                    return setShops_(
                        allShops.filter((shop) => shop._id === inputText)
                    );
                case "name":
                    return setShops_(
                        allShops.filter((shop) => shop.name === inputText)
                    );
                default:
                    return "";
            }
        ...
        return allShops !== null &&
            ...
            <Card plain>
                ...
                <CardBody>
                    ...
                    >
                        {" "}
                        <span>Owned By</span> <span>Owner Id</span>
                    </p>
                    <p
                        className={classes.pCardContent}
                        style={{
                            display: "flex",
                            justifyContent: "space-between",
                        }}
                    >
                        <span>{user.name}</span> <span>{shop.user}</span>
                    </p>
                    <br />

                    <p className={classes.pCardTitle}>Description </p>
                    <p className={classes.pCardContent}>{shop.description}</p>
                    <br />
                    ...
                    >
                        {" "}
                        <span>No of Products in shop</span> <span>Phone</span>
                    </p>
                    <p
                        className={classes.pCardContent}
                        style={{
                    ...
                    <p className={classes.pCardContent}>{shop.address}</p>
                    <br />

                    <p className={classes.pCardTitle}>Created at </p>
                    <p className={classes.pCardContent}>
                        {Moment2(
                            shop.createdAt !== null && shop.createdAt
        ...
        <div style={{ width: "100%" }}>
            ...
            <Grid container spacing={2} style={{ marginLeft: "0.5em" }}>
                ...
                {showShopCard && (
                    <Fab
                        aria-label="add"
                        style={{ marginLeft: "5em", marginTop: "4em" }}
                ...
                {shops_ !== null && shops_.length > 0 && showShopCard ? (
                    <Grid
                        ...
                        md={8}
                        lg={7}
                        style={{ margin: "2em", marginLeft: "8vw" }}
                    >
                        <ShopCardDelete
                            shop={currentShop}
