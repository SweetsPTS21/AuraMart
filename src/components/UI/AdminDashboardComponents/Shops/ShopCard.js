...
export const ShopCard = ({ shop, setCurrentOrders, toggleShop }) => {
        ...
        >
            ...
            >
                ...
                <p style={{ fontSize: "0.8em" }}>
                    <TodayIcon style={{ fontSize: "1.1em" }} />{" "}
                    {Moment2(shop.createdAt).format("MMMM DD, YYYY")}
                </p>
            </CardHeader>
            <CardBody>
                ...
                <div className={classes.cardCategory}>
                    ...
                    product in shop
                    <p style={{ marginTop: "0.3em", fontSize: "1.1em" }}>
