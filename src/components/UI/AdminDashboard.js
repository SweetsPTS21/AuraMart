...
const AdminDashBoard = (props) => {
    ...
    const optionsSubMenuItemsIcon = [
        [],
        [
            <PeopleOutlineIcon className={classes.item} />,
        ...
        [
            <PhoneIphoneIcon className={classes.item} />,
            <InfoIcon className={classes.item} />,
            <InfoIcon className={classes.item} />,
            <AddIcon className={classes.item} />,
            <UpdateIcon className={classes.item} />,
        ...
        [
            <CardTravelIcon className={classes.item} />,
            <InfoIcon className={classes.item} />,
            <InfoIcon className={classes.item} />,
            <AddIcon className={classes.item} />,
            <UpdateIcon className={classes.item} />,
        ...
        [
            <RateReviewIcon className={classes.item} />,
            <InfoIcon className={classes.item} />,
            <InfoIcon className={classes.item} />,
            <AddIcon className={classes.item} />,
            <UpdateIcon className={classes.item} />,
    ...
    const optionsMenuToggleVariable = [
        null,
        userMenu,
        productMenu,
        shopMenu,
    ...
    const optionsMenuToggleVariableSetter = [
        null,
        setUserMenu,
        setProductMenu,
        setShopMenu,
                ...
                return (
                    <section key={uuid()}>
                        ...
                        >
                            ...
                            />
                            {optionsMenuToggleVariable[index] ? (
                                <ExpandLess className={classes.item} />
                            ) : (
                        ...
                        <Collapse
                            in={optionsMenuToggleVariable[index]}
                            timeout={"auto"}
                            unmountOnExit
                                ...
                                {optionsSubItems[index].map((item, index_) => {
                                    ...
                                    return (
                                        <ListItem
                                            ...
                                            key={uuid()}
                                            onClick={(event) =>
                                                handleMenuItemClick(event, temp)
                                            }
                                            selected={temp === selectedIndex}
                                        >
                                            <ListItemIcon>
                                                {
                                                    optionsSubMenuItemsIcon[
                                                        index
                                                    ][index_]
                                                }
                                            </ListItemIcon>
                ...
                <Grid item xs={3} className={classes.sideBar}>
                    ...
                    >
                        <Dashboard
                            ...
                            style={{ fontSize: "2.2em", marginRight: "0.3em" }}
                        />
                        <p
                            style={{
